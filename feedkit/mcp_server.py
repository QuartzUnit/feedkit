...
mcp = FastMCP(
    "feedkit",
    instructions="RSS/Atom feed collection with 449 curated feeds. Search, subscribe, collect, and search articles.",
)
...
def search_feed_catalog(query: str = "", category: str = "", language: str = "", count: int = 20) -> str:
    """Search the built-in catalog of 449 curated RSS feeds.
